...
const CalculationModal: NextComponentType = () => {
  ...
  const specialMasksBasePoints: Record<SpecialMaskKeys, number> = {
    "Unique Ones": 20,
    Baba: 10,
    LED: 10,
  };
  ...
  return (
    <div className="flex h-full w-full flex-col gap-4 overflow-y-scroll [&::-webkit-scrollbar]:hidden">
      ...
      <div className="my-4 mt-2 w-full md:mt-4">
        ...
        {/* special masks */}
        <div className="my-4 grid w-full grid-cols-2 items-center justify-between gap-3 space-y-2 pr-1 md:flex md:space-y-0">
